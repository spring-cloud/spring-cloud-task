...
You need to have Java installed (Java 7 or better -- we recommend Java 8). To build, you
need to have Maven installed as well.
...
good support for Apache Maven, so we use it as the build tool for this project since.
...
// TODO: What documentation? The Spring Initalizr doesn't have any documentation links.
