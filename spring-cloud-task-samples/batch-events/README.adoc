...
Note: More information on this topic is available http://docs.spring.io/spring-cloud-task/1.0.0.M2/reference/htmlsingle/#stream-integration-batch-events[here].
