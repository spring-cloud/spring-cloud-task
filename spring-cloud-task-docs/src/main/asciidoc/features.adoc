...
A Spring Cloud Task the approach that a Spring Boot application can have a start and an
...
Upon completion of all of the `*Runner`s from Spring Boot or the failure of an
...
exit code generated, it's assumed to be 0.
